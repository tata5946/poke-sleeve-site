...
/* ----- Config ----- */
const GAS_URL = "https://script.google.com/macros/s/AKfycbziDNX6nOuoYk8CQ3geI_89fqgfs7PL2Ubb5vC6u0C32Df6gK3vIUoJrJFYli1eax1y/exec";
const GA_MEASUREMENT_ID = "G-FLDX8EB1W8";
const FAVICON_PATH = "./assets/favicon.svg";
const LOCAL_DATA_URL = "./data.json";
const DATA_CACHE_KEY = "pokeSleeve:dataCache:v8";
const DATA_PERSISTENT_CACHE_KEY = "pokeSleeve:dataCache:persist:v8";
...
<div class="header">
  <div class="header-top">
    ...
    <a href="./index.html" class="brand">
      <img class="site-title-logo site-title-logo--header" src="./assets/site-title-logo.svg?v=20260422c" alt="ポケスリ相場ナビ" />
    </a>
...
function buildDashboardSidebarHtml(activeSidebar = "") {
  ...
  <div class="sidebar-brand">
    <img class="site-title-logo site-title-logo--sidebar" src="./assets/site-title-logo.svg?v=20260422c" alt="ポケスリ相場ナビ" />
  </div>
