...
const LOCAL_DATA_URL = "./data.json?v=20260706a";
...
const DATA_CACHE_KEY = "pokeSleeve:dataCache:v13";
const DATA_PERSISTENT_CACHE_KEY = "pokeSleeve:dataCache:persist:v13";
