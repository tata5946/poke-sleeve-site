...
const LOCAL_DATA_URL = "./data.json?v=20260901a";
...
const DATA_CACHE_KEY = "pokeSleeve:dataCache:v24";
const DATA_PERSISTENT_CACHE_KEY = "pokeSleeve:dataCache:persist:v24";
